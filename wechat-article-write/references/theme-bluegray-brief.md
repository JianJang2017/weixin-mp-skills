...
<section style="margin:18px 0 24px;padding:15px 16px;background:#f5f8fb;border:1px solid #d8e1ea;border-radius:6px;">
  <p style="margin:0 0 6px;font-size:13px;color:#1769aa;font-weight:900;">参考文章</p>
  <p style="margin:0 0 8px;font-size:15px;line-height:1.7;color:#101828;font-weight:800;">{{label}}</p>
  <p style="margin:0;font-size:13px;line-height:1.65;color:#1769aa;word-break:break-all;">{{url}}</p>
</section>
```
