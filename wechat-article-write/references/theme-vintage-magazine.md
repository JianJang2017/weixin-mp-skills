...
<section style="margin:20px 0 26px;padding:15px 16px;background:#f6efe3;border:1px solid #ddd2c2;">
  <p style="margin:0 0 6px;font-size:13px;color:#b42318;font-weight:800;">参考文章</p>
  <p style="margin:0 0 8px;font-size:15px;line-height:1.75;color:#17130f;font-weight:800;">{{label}}</p>
  <p style="margin:0;font-size:13px;line-height:1.7;color:#7a5c2e;word-break:break-all;">{{url}}</p>
</section>
```
